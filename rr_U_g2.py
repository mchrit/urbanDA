...
tracer_file = 'RANS_OKC_NW/tracer_U_time_all.csv' #'/home/mounir.chrit/hampton-NE_WS=3.281123477404996_WD=45.0/tracer_time_all.csv'
...
def da():
    file_obs='RANS_OKC_NW/index_time_U.csv'
...
#            g2 = np.dot(VT,g1)
    ...
    xDA = xB + deltaxDA
    file_a = open('new_U_analysis_'+ group + '.csv','w')
